...
--
-- Host: localhost
-- Generation Time: Feb 10, 2025 at 03:25 AM
...
INSERT INTO `Events` (`EventID`, `EventName`, `EventDescription`, `EventDate`, `EventTime`, `Location`, `Organizer`, `CreatedAt`, `rules`) VALUES
(3, 'hi', 'hkvik', '2025-02-21', '06:28:00', 'Udupi', 'kwndw', '2025-02-08 12:40:21', 'wd');
...
--
ALTER TABLE `completed_events`
  MODIFY `CompletedEventID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
